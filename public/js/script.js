...
(function () {
  ...
  var I18N = {
    en: {
      ...
      'secret.hall':'🪩 Welcome to the after-party — keep it between us!',
      ...
      'rsvp.name':'Your name','rsvp.name.ph':'e.g. Aram Petrosyan',
    ...
    ru: {
      ...
      'secret.hall':'🪩 Добро пожаловать на афтепати — только между нами!',
      ...
      'rsvp.name':'Ваше имя','rsvp.name.ph':'напр. Арам Петросян',
    ...
    hy: {
      ...
      'secret.hall':'🪩 Բարի գալուստ աֆթափարթի — թող մնա մեր մեջ։',
      ...
      'rsvp.name':'Ձեր անունը','rsvp.name.ph':'օր․՝ Արամ Պետրոսյան',
